    ...
    <DragDropContext onDragEnd={handleDragEnd}>
      <div className="app-container flex">
        <Droppable droppableId="drop-area-id">
          {(provided) => (
            <div ref={provided.innerRef} {...provided.droppableProps} className="drop-area-container flex-grow border-r-2 p-4">
              <DropArea 
        ...
        <Droppable droppableId="sidebar" isDropDisabled={true}>
          {(provided) => (
            <div ref={provided.innerRef} {...provided.droppableProps} className="sidebar-container w-64 p-4">
